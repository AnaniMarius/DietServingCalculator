package com.example.servingcalculator.ui.notifications;
...
import com.example.servingcalculator.databinding.FragmentNotificationsBinding;
...
//        notificationsViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
    ...
    public void onResume() {
        super.onResume();
        TextView meanTxt=root.findViewById(R.id.monthTxtMeanMain);
        TextView thresholdTxt=root.findViewById(R.id.monthTxtThresholdMain);
    ...
    public static boolean isThisMonth(LocalDateTime dateTime) {
        ...
        LocalDateTime endOfMonth = now.with(TemporalAdjusters.lastDayOfMonth()).withHour(23).withMinute(59).withSecond(59).withNano(999_999_999);
